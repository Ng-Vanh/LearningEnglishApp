...
//
//            FadeTransition fadeOut = new FadeTransition(Duration.seconds(0.01), snapshot);
//            fadeOut.setToValue(0);
//            fadeOut.setOnFinished(e -> {
//                stage.setScene(newScene);
//                stage.setTitle(title);
//
//                TranslateTransition transition = new TranslateTransition(Duration.seconds(0.1), root);
//                transition.setToX(0);
